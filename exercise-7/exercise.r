...
score.most.yards <- husky.scores[combined.yards == max(combined.yards)]
score.most.yards
...
games.2016 <- read.csv('data/huskies_2016.csv')
most.yards.score.2016 <- MostYardsScore(games.2016)
most.yards.score.2016
